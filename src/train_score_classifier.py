...
# em_ner_path = 'models/ExactMatchNER/umls.2024AA.active.st21pv.nerfed_nlp_and_matcher.max3.p'
ngram_db_path = 'models/SimString/umls.2024AA.active.st21pv.aliases.3gram.5toks.db'
ngram_map_path = 'models/SimString/umls.2024AA.active.st21pv.aliases.5toks.map'
