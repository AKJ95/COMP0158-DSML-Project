...
MEDMENTIONS_ST21PV_ROOT = os.path.join(MEDMENTIONS_ROOT, "st21pv", "data")
MEDMENTIONS_ST21PV_PATH = os.path.join(MEDMENTIONS_ST21PV_ROOT, "corpus_pubtator.txt")
MEDMENTIONS_NER_PATH = os.path.join(PROCESSED_DATA_ROOT, "medmentions-ner.csv")
MEDMENTIONS_ST21PV_NER_PATH = os.path.join(PROCESSED_DATA_ROOT, "medmentions-st21pv-ner.csv")
