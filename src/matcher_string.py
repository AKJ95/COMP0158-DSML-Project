...
def create_umls_ss_db(umls_kb, char_ngram_len=3, n_max_tokens=5):
    ...
    # setting paths
    db_path = 'data/processed/%s.aliases.%dgram.%dtoks.db' % (umls_kb.umls_version, char_ngram_len, n_max_tokens)
    map_path = 'data/processed/%s.aliases.%dtoks.map' % (umls_kb.umls_version, n_max_tokens)
