...
if __name__ == '__main__':
    ...
    mm_docs = read_mm_converted('data/processed/mm_converted.%s.json' % split_label)
    ...
    vecs_path = 'data/processed/mm_st21pv.%s.%s.precomputed' % (split_label, PYTT_CONFIG['name'])
